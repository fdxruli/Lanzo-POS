...
| src/pages/__tests__/PublicStoreCheckout.test.jsx > PublicStorePage checkout integration closes editing and recoverable checkout states without clearing the cart | FAIL in BASE repetition(s) 1: Error: STACK_TRACE_ERROR | PASS/absent in all CANDIDATE repetitions | INCIDENTAL_OR_BASELINE_FLAKE |
