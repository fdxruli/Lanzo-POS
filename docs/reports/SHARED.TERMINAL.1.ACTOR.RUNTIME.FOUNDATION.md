...
- repetition 1: 2793 passed / 93 failed / 51 skipped / 2937 total; 81 failed files / 721 passed files / 802 total files
...
- unique BASE failure observations: 113
...
- BASE-only/incidental-or-flaky observations: 1
...
| src/pages/__tests__/PublicStorePage.siteVersion.test.jsx > PublicStorePage published site versions keeps v1 while only the draft changes, then renders v2 without changing catalogRevision | FAIL in BASE repetition(s) 1: Error: STACK_TRACE_ERROR | PASS/absent in all CANDIDATE repetitions | INCIDENTAL_OR_BASELINE_FLAKE |
