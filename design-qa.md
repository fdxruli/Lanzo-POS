...
- Visual source and comparison captures are generated locally and intentionally excluded from version control; reproduce them under `artifacts/` when needed.
...
- State: demo storefront with a personalized dark theme and eight synthetic catalog products
...
The rendered implementation uses three columns at the 843 px breakpoint instead of the concept's four because the demo catalog contains longer product names and purchase controls. Mobile uses two columns in grid mode and one readable row per product in list mode.
...
- Source mobile: `<source-image>` (274 x 558)
- Generated mobile result: `artifacts/public-store-footer-mobile-final-274x558.png` (274 x 558)
- Mobile comparison: `artifacts/public-store-footer-mobile-comparison-final.png`
- Source desktop: `<source-image>` (900 x 562)
- Generated desktop result: `artifacts/public-store-footer-desktop-final-900x562.png` (900 x 562)
- Desktop comparison: `artifacts/public-store-footer-desktop-comparison-final.png`
...
- Source visual truth: `<source-image>`
...
- Source visual truth path: `<source-image>`
...
- Source visual truth: desktop option 3 at `<source-image>`.
...
- Source visual truth path: `<source-image>`
- Original product reference: `<source-image>`
...
- State: light theme, `/pedidos-online`, representative authenticated order data.
...
- P3: The generated concept contains sample product photography while the demo catalog lacks images for several representative products. This is a data constraint, not a layout defect.
...
- Visual evidence: `artifacts/public-cart-controls-fixed.png` (generated locally and not versioned).
...
- Demo portal evidence: `demo-store` resolves to `Abarrotes / Tienda`.
- Desktop evidence: `artifacts/public-store-business-type-header.png` (generated locally and not versioned).
- Mobile evidence: `artifacts/public-store-business-type-header-mobile.png` (generated locally and not versioned).
