...
const SAFE_ERROR_MESSAGES = {
  ...
  ECOMMERCE_PRODUCT_REQUIRES_REVIEW: 'Este producto requiere revisión antes de publicarse. Publícalo sin extras o corrige su configuración.',
  ECOMMERCE_PRODUCT_HIDDEN_INCOMPATIBLE: 'Este producto es incompatible con la tienda y no se puede publicar.',
  ECOMMERCE_PRODUCT_PUBLICATION_INELIGIBLE: 'Este producto todavía no cumple los requisitos para mostrarse en la tienda.',
