...
import { Archive, AlertTriangle, CheckCircle, ChefHat, Flame, History, RefreshCw, X } from 'lucide-react';
...
export default function CloudKitchenMonitorRest8Core({ kitchenCloud, onAdvanceStatus, onCancelOrder, onChangeItemStatus, onCancelItemStatus, onArchiveOrder }) {
  const {
