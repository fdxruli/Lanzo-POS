-- REST.INV.5 / REST.INV.5.1 — verificación rápida de reglas de extras cloud.
...
select
  ...
  private.rest_inv5_modifier_tracks_inventory('{"ingredientId":"ing_queso","ingredientQuantity":30,"tracksInventory":false}'::jsonb) = true as explicit_false_is_corrected,
  private.rest_inv5_modifier_tracks_inventory('{"name":"Empaque extra","price":5,"tracksInventory":true}'::jsonb) = false as true_without_ingredient_is_false,
  private.rest_inv5_modifier_tracks_inventory('{"ingredientId":"ing_queso","tracksInventory":true}'::jsonb) = false as true_without_quantity_is_false,
  private.rest_inv5_modifier_tracks_inventory('{"ingredientId":"ing_tocino","quantity":25,"tracksInventory":false}'::jsonb) = true as legacy_quantity_false_is_corrected;
