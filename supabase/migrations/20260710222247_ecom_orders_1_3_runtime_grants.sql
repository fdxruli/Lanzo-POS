...
-- Pedidos ecommerce: endpoints públicos aprobados para custom auth.
...
-- Centro de Notificaciones: RPCs consumidas por cloudNotificationService.
...
-- Defensa en profundidad: los helpers de autorización continúan fuera de la API.
