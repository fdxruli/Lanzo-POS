...
COMMENT ON FUNCTION private.sec4_security_surface_audit() IS 'SEC.4.1: auditoría interna app-owned para SECURITY DEFINER, search_path, grants reales, owners y views.';
