-- Repair the authoritative administrative cash-close definition after Shared
-- Terminal 4 added closed_by_actor_key without declaring its actor variable.
-- Session ownership (actor_key) remains historical and is never rewritten.
begin;
...
begin
  ...
  set status = 'closed',
      ...
      closed_by_actor_key = v_actor_key,
...
-- The public rate-limited wrapper remains the sole client entry point.
