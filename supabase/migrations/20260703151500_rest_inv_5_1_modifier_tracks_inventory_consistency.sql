-- FASE REST.INV.5.1 — Coherencia defensiva de tracksInventory en helpers SQL cloud
--
-- tracksInventory explícito no debe contradecir datos reales normalizados.
-- Si hay ingredientId + cantidad válida, el extra es inventariable.
-- Si falta ingrediente o cantidad válida, el extra no es inventariable.
