-- ECOM.FE.ADMIN.1.1.1 - Corregir fragmentacion del rate limiter administrativo.
-- Todas las llamadas ecommerce administrativas usan un bucket previo por dispositivo.
-- El token staff se conserva exclusivamente para la autorizacion posterior.
