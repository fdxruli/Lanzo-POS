-- FASE CAD.3.1 — Pulido menor de unidad cloud en historial de mermas por caducidad.
-- Reemplaza solo la lectura de historial; no modifica la mutacion pos_register_expiration_waste.
