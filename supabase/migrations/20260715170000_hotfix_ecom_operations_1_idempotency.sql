...
-- The sole semantic change is moving the existing-order return immediately after
-- portal resolution and idempotency-key validation, before new-order validation
-- and rate limiting.
